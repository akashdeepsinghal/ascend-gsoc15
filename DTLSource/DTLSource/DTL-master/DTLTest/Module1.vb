...
Module Module1
    ...
    Sub Main()
        ...
        Dim ip As Double() = dtlc.GetInteractionParameterSet("NRTL", "Water", "Ethanol")
        Console.WriteLine("A12 = " & ip(1).ToString & " cal/mol")
        Console.WriteLine("A21 = " & ip(2).ToString & " cal/mol")
        Console.WriteLine("alpha = " & ip(3).ToString)
