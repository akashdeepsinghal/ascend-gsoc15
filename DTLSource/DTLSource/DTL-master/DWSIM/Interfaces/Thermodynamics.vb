...
Namespace Thermodynamics
    ...
    Public Class Calculator
        ...
        <System.Runtime.InteropServices.DispId(16)> Public Function CalcProp( _
            ...
            Dim results2(values.Length - 1) As Double
        ...
        <System.Runtime.InteropServices.DispId(26)> Public Function PTFlash( _
            ...
            Optional ByVal ip2 As Object = Nothing, _
            Optional ByVal ip3 As Object = Nothing, _
            Optional ByVal ip4 As Object = Nothing) As String(,)
            ...
            Dim fractions(compounds.Length + 1, labels.Length - 1) As String
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        <System.Runtime.InteropServices.DispId(37)> Public Function GetInteractionParameterSet(ByVal Model As String, ByVal Compound1 As String, ByVal Compound2 As String) As Double()
            ...
            Select Case Model
                ...
                Case "UNIQUAC"
                    ...
                    pp = Nothing
            End Select
            Dim parA12, parA21, alpha As Double
            Dim param(3) As Double
            parA12 = pars("A12")
            parA21 = pars("A21")
            If pars.ContainsKey("alpha") = True Then
                alpha = pars("alpha")
            Else
                alpha = 0
            End If
            param = {parA12, parA21, alpha}
            Return param
